...
export default function Appoitments(props) {
    ...
    return (
        <div className={`row py-5 underline ${props.item.deleted ? 'bc-red' : props.item.done ? 'bc-green' : ''}`} key={props.item.id}>
            ...
            <div className={`colomun importance ${props.item.levelOfImportance === 0 ? 'bc-green' :
            ...
            <div className="column data">{props.item.date}</div>
